...
//TODO 2.1. Проверить скорость записи отчета и при необходимости оптимизировать процесс,
//TODO 2.2. Доработать значки файлов и папок на форме в соответствии со значками на отчете,
//TODO 3. Улучшить алгоритм для фраз
//поработать по фразе    19. ВИА «Сябры» - Лягу-Прилягу.mp3
//TODO 4. Сделать динамический фильтр если указано расширение
